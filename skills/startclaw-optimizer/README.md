...
Automatic token tracking and context compaction for multi-agent workflows.
...
The compactor identifies and preserves messages matching:
- "task objective"
- "error message"
- "code reference"
...
cd ~/.clawdbot/skills/startclaw-optimizer
npm install
```
